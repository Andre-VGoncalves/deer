package com.curator.ui.theme

import androidx.compose.ui.graphics.Color

val Primary = Color(0xFF93452B)
val OnPrimary = Color(0xFFFFFFFF)
val PrimaryContainer = Color(0xFFB25D41)
val OnPrimaryContainer = Color(0xFFFFFBFF)

val Secondary = Color(0xFF4F6354)
val OnSecondary = Color(0xFFFFFFFF)
val SecondaryContainer = Color(0xFFCFE5D2)
val OnSecondaryContainer = Color(0xFF536758)

val Tertiary = Color(0xFF676000)
val OnTertiary = Color(0xFFFFFFFF)
val TertiaryContainer = Color(0xFFB7AE47)
val OnTertiaryContainer = Color(0xFF464100)
...
val OnSurfaceVariant = Color(0xFF55433D)

val Outline = Color(0xFF88726C)
